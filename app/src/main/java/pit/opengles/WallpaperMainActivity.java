...
public class WallpaperMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isValidGLES()) {
            ...
            throw new RuntimeException("错误：程序需要 OpenGL ES 2.0 支持，但是本设备不支持。");
        }
        ...
        switch (currentColor) {
            ...
            case "PHOTO":
                ...
                dropDownImage.setBackgroundColor(Color.rgb(10, 10, 10));
                cd_box.setCardBackgroundColor(Color.rgb(10, 10, 10));
                break;
        }
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch ((int) id) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        _mRenderer.switchColors("PHOTO");
                        editor.putString("color", "PHOTO");
                        dropDownImage.setBackgroundColor(Color.rgb(10, 10, 10));
                        cd_box.setCardBackgroundColor(Color.rgb(10, 10, 10));
                        break;
                }
